...
PETEREPORT_TEMPLATES = {
    ...
    'report_id_format': env.str('PETEREPORT_REPORT_ID', default='网安渗评〔{date}〕第{number}号'),
    'report_title': env.str('PETEREPORT_TITLE', default='网络安全评估-渗透测试报告'),
...
PETEREPORT_MARKDOWN = {
    'pdf_engine': env.str('PETEREPORT_PDF_ENGINE', default='xelatex'), # pdflatex or xelatex
